...
if [ -e "${REPO_ROOT}/experiments/game_bigrec/google_gemma-2B-it/bigrec_infer_train/random_0_0.5_seed_99_alpha_0.5/train_epoch_best.json" ]; then
    echo "Skipping BIGRec Inference (Output exists: ${REPO_ROOT}/experiments/game_bigrec/google_gemma-2B-it/bigrec_infer_train/random_0_0.5_seed_99_alpha_0.5/train_epoch_best.json)"
else
...
if [ -e "${REPO_ROOT}/experiments/game_bigrec/google_gemma-2B-it/dllm2rec_final/random_0_0.5_seed_99_alpha_0.5/ed_0.3_lam_0.7/metrics.json" ]; then
    ...
    OUTPUT_DIR=${REPO_ROOT}/experiments/game_bigrec/google_gemma-2B-it/dllm2rec_final/random_0_0.5_seed_99_alpha_0.5/ed_0.3_lam_0.7 RANKING_PATH=${REPO_ROOT}/experiments/game_bigrec/google_gemma-2B-it/bigrec_infer_train/random_0_0.5_seed_99_alpha_0.5/train_epoch_best_rank.txt CONFIDENCE_PATH=${REPO_ROOT}/experiments/game_bigrec/google_gemma-2B-it/bigrec_infer_train/random_0_0.5_seed_99_alpha_0.5/train_epoch_best_score.txt EMBEDDING_PATH=BIGRec/data/game_bigrec/model_embeddings/google_gemma-2B-it.pt ./cmd/run_dllm2rec_train.sh game_bigrec SASRec 0 0.3 0.7 '' 99 1024 best
fi
